...
PROJE_SENARYOLARI = (
    ...
    ("askı ve kabin ters işaretli", dict(_B, aski_kaciklik_x=-300, aski_kaciklik_y=-80,
                                         kabin_kaciklik=120)),
    ("makaralı paten", dict(_B, paten_tipi="Makaralı", agirlik_paten_tipi="Makaralı")),
    ("makaralı paten + ℓ", dict(_B, paten_tipi="Makaralı", agirlik_paten_tipi="Makaralı",
                                paten_balata_boyu=120)),
    #  Paten tipi ray başınadır;  girilen ℓ yalnız kabin pateninindir.
    ("kabin kaymalı · ağırlık makaralı", dict(_B, agirlik_paten_tipi="Makaralı")),
    ("kabin makaralı · ağırlık kaymalı", dict(_B, paten_tipi="Makaralı")),
    ("kabin ℓ girilmiş · ağırlıkta ℓ türetilir", dict(_B, paten_balata_boyu=140)),
    ...
    ("hepsi bir arada", dict(_B, kabin_kaciklik=-90, aski_kaciklik_x=180, aski_kaciklik_y=-40,
                             paten_tipi="Makaralı", agirlik_paten_tipi="Makaralı",
                             klips_itme_kuvveti=250, yapi_sehim_x=0.5,
    ...
    ("ELEport projesi", dict(
        ...
        agirlik_paten_tipi="Makaralı", agirlik_genisligi=850, agirlik_derinligi=160,
